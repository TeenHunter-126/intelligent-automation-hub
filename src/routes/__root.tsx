...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Muhammad Zia Ul Hassan — Robotics, Industrial Automation, Machine Learning, and Control Systems engineer." },
      { name: "author", content: "Muhammad Zia Ul Hassan" },
